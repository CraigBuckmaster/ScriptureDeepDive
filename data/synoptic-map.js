...
,
  ...
  {id:"chr-saul-death",  cat:"ot-parallel", title:"Saul's Death",
   cols:[{book:"1_samuel",ch:31,label:"1 Sam 31"},{book:"1_chronicles",ch:10,label:"1 Chr 10"}],
   note:"The Chronicler adds a theological verdict: Saul died for unfaithfulness and consulting a medium."},
  {id:"chr-david-anointed",cat:"ot-parallel",title:"David Anointed King",
   cols:[{book:"2_samuel",ch:5,label:"2 Sam 5"},{book:"1_chronicles",ch:11,label:"1 Chr 11"}],
   note:"Chronicles omits the 7-year civil war; 'all Israel' anoints David immediately."},
  {id:"chr-ark-procession",cat:"ot-parallel",title:"The Ark Comes to Jerusalem",
   cols:[{book:"2_samuel",ch:6,label:"2 Sam 6"},{book:"1_chronicles",ch:15,label:"1 Chr 15-16"}],
   note:"Chronicles adds extensive Levitical detail and David's psalm of thanksgiving."},
  {id:"chr-davidic-covenant",cat:"ot-parallel",title:"The Davidic Covenant",
   cols:[{book:"2_samuel",ch:7,label:"2 Sam 7"},{book:"1_chronicles",ch:17,label:"1 Chr 17"}],
   note:"Nearly identical accounts — the covenant is too important to paraphrase."},
  {id:"chr-census",cat:"ot-parallel",title:"David's Census",
   cols:[{book:"2_samuel",ch:24,label:"2 Sam 24"},{book:"1_chronicles",ch:21,label:"1 Chr 21"}],
