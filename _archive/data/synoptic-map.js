...
,
  ...
  {id:"chr-saul-death",  category:"ot-parallel", title:"Saul's Death",
   passages:[{book:"1_samuel",ref:"1 Sam 31",label:"1 Sam 31"},{book:"1_chronicles",ref:"1 Chr 10",label:"1 Chr 10"}],
   note:"The Chronicler adds a theological verdict: Saul died for unfaithfulness and consulting a medium."},
  {id:"chr-david-anointed",category:"ot-parallel",title:"David Anointed King",
   passages:[{book:"2_samuel",ref:"2 Sam 5",label:"2 Sam 5"},{book:"1_chronicles",ref:"1 Chr 11",label:"1 Chr 11"}],
   note:"Chronicles omits the 7-year civil war; 'all Israel' anoints David immediately."},
  {id:"chr-ark-procession",category:"ot-parallel",title:"The Ark Comes to Jerusalem",
   passages:[{book:"2_samuel",ref:"2 Sam 6",label:"2 Sam 6"},{book:"1_chronicles",ref:"1 Chr 15",label:"1 Chr 15-16"}],
   note:"Chronicles adds extensive Levitical detail and David's psalm of thanksgiving."},
  {id:"chr-davidic-covenant",category:"ot-parallel",title:"The Davidic Covenant",
   passages:[{book:"2_samuel",ref:"2 Sam 7",label:"2 Sam 7"},{book:"1_chronicles",ref:"1 Chr 17",label:"1 Chr 17"}],
   note:"Nearly identical accounts — the covenant is too important to paraphrase."},
  {id:"chr-census",category:"ot-parallel",title:"David's Census",
   passages:[{book:"2_samuel",ref:"2 Sam 24",label:"2 Sam 24"},{book:"1_chronicles",ref:"1 Chr 21",label:"1 Chr 21"}],
   note:"'The LORD' (2 Sam) vs 'Satan' (1 Chr) — the most famous divergence between the two histories."},
];
