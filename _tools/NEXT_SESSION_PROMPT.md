...
1. **Theme Batch T6** — Legacy cleanup (remove static base export, update DEV_GUIDE)
2. **Deep Study Features Phase 21** — Concordance Search (depends on Phase 13) — Session O
