...
BOOK_ROSTER = [
    ...
    ('job',            'Job',           range(1, 43),  'ot'),
    ('ecclesiastes',   'Ecclesiastes',  range(1, 13),  'ot'),
    ('song_of_solomon','Song of Solomon',range(1, 9),   'ot'),
    ('psalms',         'Psalms',         range(1, 151), 'ot'),
...
SCHOLAR_KEYS = {
    ...
    '2 Chronicles':['selman',   'japhet',  'calvin', 'netbible'],
}
...
OT_BOOKS = ['genesis','exodus','leviticus','numbers','deuteronomy','joshua','judges','ruth','1_samuel','2_samuel','1_kings','2_kings','1_chronicles','2_chronicles','ezra','nehemiah','esther','job','ecclesiastes','song_of_solomon','psalms','proverbs']
...
old_flat = re.findall(r"'/(genesis|exodus|ruth|ezra|nehemiah|esther|job|ecclesiastes|song_of_solomon|psalms|proverbs|matthew|mark|luke|john|acts)/[^']+\.html'", sw)
if old_flat:
