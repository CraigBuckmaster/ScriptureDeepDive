...
(function() {
  ...
  function cacheLegacyData() {
    var bookVars = [
      ...
      'VERSES_NEHEMIAH','VERSES_ESTHER','VERSES_JOB','VERSES_ECCLESIASTES','VERSES_SONG_OF_SOLOMON','VERSES_PSALMS','VERSES_DANIEL','VERSES_PROVERBS','VERSES_MATTHEW','VERSES_MARK',
