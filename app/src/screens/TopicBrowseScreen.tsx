...
export default function TopicBrowseScreen() {
  ...
  const headerComponent = (
    <View style={styles.headerPad}>
      <ScreenHeader title="Topical Index" onBack={() => navigation.goBack()} style={styles.headerSpacing} />
      <View style={{ marginBottom: spacing.sm }}>
        <SearchInput value={search} onChangeText={setSearch} placeholder="Search topics..." />
      </View>
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: base.bg }]}>
      <SectionList
        ...
        ListEmptyComponent={
          <View style={styles.emptyState}>
            <Text style={[styles.emptyText, { color: base.textMuted }]}>No topics found</Text>
          </View>
        }
      />
    </SafeAreaView>
